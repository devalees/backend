...
urlpatterns = [
    ...
    # Team Member URLs
    path('<int:org_pk>/departments/<int:dept_pk>/teams/<int:team_pk>/members/', views.team_member_list, name='team_member_list'),
    path('<int:org_pk>/departments/<int:dept_pk>/teams/<int:team_pk>/members/<int:pk>/', views.team_member_detail, name='team_member_detail'),
    path('<int:org_pk>/departments/<int:dept_pk>/teams/<int:team_pk>/members/create/', views.team_member_create, name='team_member_create'),
    path('<int:org_pk>/departments/<int:dept_pk>/teams/<int:team_pk>/members/<int:pk>/update/', views.team_member_update, name='team_member_update'),
    path('<int:org_pk>/departments/<int:dept_pk>/teams/<int:team_pk>/members/<int:pk>/delete/', views.team_member_delete, name='team_member_delete'),
] 