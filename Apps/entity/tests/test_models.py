...
class TestOrganizationModel:
    ...
    def test_organization_unique_name(self, user):
        """Test that organization names must be unique"""
        Organization.objects.create(name='Test Org', created_by=user)
        org2 = Organization(name='Test Org', created_by=user)
        with pytest.raises(ValidationError):
            org2.full_clean()

    def test_organization_soft_delete(self, user):
...
class TestDepartmentModel:
    ...
    def test_create_department(self, organization, user):
    ...
    def test_department_unique_name_per_organization(self, organization, user):
    ...
    def test_department_same_name_different_entities(self, user):
        """Test that departments can have same name in different entities"""
        org1 = Organization.objects.create(name='Org 1', created_by=user)
        org2 = Organization.objects.create(name='Org 2', created_by=user)
...
class TestTeamModel:
    ...
    def test_create_team(self, department, user):
    ...
    def test_team_unique_name_per_department(self, department, user):
    ...
    def test_team_same_name_different_departments(self, organization, user):
