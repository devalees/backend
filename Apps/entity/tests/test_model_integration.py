...
class TestDepartmentIntegration:
    ...
    def test_department_field_constraints(self, organization, user):
        ...
        Department.objects.create(name="Test Dept", organization=organization, created_by=user)
        with pytest.raises(ValidationError) as exc_info:
            Department.objects.create(name="Test Dept", organization=organization, created_by=user)
        assert "A department with this name already exists in this organization" in str(exc_info.value)

    def test_department_organization_relationship(self, organization, user):
        """Test department-organization relationship"""
        # Test department creation
        department = Department.objects.create(name="Test Dept", organization=organization, created_by=user)
    ...
    def test_department_hierarchy(self, organization, user):
        """Test department hierarchy"""
        parent = Department.objects.create(name="Parent Dept", organization=organization, created_by=user)
        child = Department.objects.create(name="Child Dept", organization=organization, parent=parent, created_by=user)
        
        assert child.parent == parent
        assert child in parent.children.all()
        assert parent in child.get_parent_departments()

    def test_department_soft_delete(self, organization, user):
    ...
    def test_department_cascade_soft_delete(self, organization, user):
    ...
    def test_department_reactivation(self, organization, user):
    ...
    def test_department_organization_constraints(self, organization, user):
        """Test department-organization constraints"""
        other_org = Organization.objects.create(name="Other Org", created_by=user)
        other_dept = Department.objects.create(name="Other Dept", organization=other_org, created_by=user)
    ...
    def test_department_circular_reference(self, organization, user):
        ...
        dept3 = Department.objects.create(name="Dept 3", organization=organization, created_by=user)
    ...
    def test_department_max_depth(self, organization, user):
