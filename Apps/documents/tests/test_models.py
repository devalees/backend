...
class TestDocument:
    def test_document_creation(self, user, organization, mock_signals):
    ...
    def test_document_str(self, user, organization, mock_signals):
    ...
    def test_document_validation(self, user, organization, mock_signals):
...
class TestDocumentVersion:
    def test_document_version_creation(self, user, organization, mock_signals):
        ...
        assert version.organization == organization
        assert mock_ver_save.called

    def test_document_version_str(self, user, organization, mock_signals):
    ...
    def test_document_version_validation(self, user, organization, mock_signals):
        ...
        with pytest.raises(ValidationError):
            version = DocumentVersion(
                document=document,
                version_number=0,  # Invalid version number
                file=SimpleUploadedFile('test.pdf', b'test content'),
                user=user,
    ...
    def test_document_version_branching(self, user, mock_signals, organization):
...
class TestDocumentClassification:
    def test_document_classification_creation(self, organization):
        ...
        assert classification.organization == organization

    def test_document_classification_str(self, organization):
    ...
    def test_document_classification_validation(self, organization):
...
class TestDocumentTag:
    def test_document_tag_creation(self, organization):
        ...
        assert tag.organization == organization

    def test_document_tag_str(self, organization):
    ...
    def test_document_tag_validation(self, organization):
